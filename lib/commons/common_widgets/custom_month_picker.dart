            ...
            Center(
              child: Text(
                ...
                style: getRegularStyle(
                    color: context.buttonColor, fontSize: MyFonts.size15),
              ),
            ),
            Row(
              ...
              children: <Widget>[
                ...
                DefaultTextStyle(
                  style: getSemiBoldStyle(
                      color: context.buttonColor, fontSize: MyFonts.size22),
  ...
  _buildButtonBar(BuildContext context) {
    ...
    return ButtonTheme(
      child: ButtonBar(
        ...
        children: [
          TextButton(
            key: const Key('CancelButtonLabelMonthPicker'),
